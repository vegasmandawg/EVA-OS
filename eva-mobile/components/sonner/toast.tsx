        ...
        <Animated.View style={wiggleAnimationStyle}>
          <Animated.View
            style={[
              ...
              styles?.toast,
              style,
              { marginHorizontal: action ? 24 : 'auto' }
            ]}
          ...
          >
            ...
            >
              ...
              <View className={
                cn(
                  action && "w-full flex flex-row justify-between items-center",
                )
              }>
                <View className="flex-1">
                  <Text
                    style={[titleStyleCtx, styles?.title]}
                ...
                >
                  {isToastAction(action) ? (
                    <Button
                      ...
                      className="h-6 py-0 px-2 bg-primary"
                    >
                      <Text
                        numberOfLines={1}
...
> = ({ variant, invert, richColors }) => {
  ...
  switch (variant) {
    ...
    case "error":
      return <CircleAlert size={20} color={color} />;
    case "warning":
